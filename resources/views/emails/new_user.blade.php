<html lang="en" xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office"><head>
        ...
        *[x-apple-data-detectors],  /* iOS */
        ...
        <h2> Welcome to <span> PDIS!</span></h2>
        <h2> Please use <span> {{$password}} </span> to login in our system <span> </span>.</h2>
        </div>
        </td>
        </tr>
        </tbody></table>
        ...
        <script type="text/javascript" async="" src="https://www.google-analytics.com/analytics.js"></script><script async="" src="https://www.googletagmanager.com/gtag/js?id=UA-23581568-13" type="text/javascript"></script>
