		...
		<div class="component-sub-content mt-4 mb-3">
			<div class="row">
				...
				<div class="col-md-6 mb-3">
					...
					<b-input :disabled="mode=='Show'" v-model="mandate.father_details.father_name" type="text"></b-input>
				</div>
				<div class="col-md-6 mb-3">
				...
				<div class="col-md-6 mb-3">
					...
					<b-input :disabled="mode=='Show'" v-model="mandate.mother_details.mother_name" type="text"></b-input>
				</div>
				<div class="col-md-6 mb-3">
				...
				<div class="col-md-6 mb-3">
					...
					<b-input :disabled="mode=='Show'" v-model="mandate.spouse_details.spouse_name" type="text"></b-input>
				</div>
				<div class="col-md-6 mb-3">
