		...
		<div class="component-sub-content mt-4 mb-3">
			...
			<div class="row">
				...
				<div class="col-md-6">
					<div class="mandate-group">
						...
						<b-input-group>
							<b-input
								:disabled="mode=='Show'"
								v-model="mandate.full_name.last_name"
								type="text"
								placeholder="Last Name"
							></b-input>
							<b-input
								:disabled="mode=='Show'"
								v-model="mandate.full_name.first_name"
								type="text"
								placeholder="First Name"
							></b-input>
							<b-input
								:disabled="mode=='Show'"
								v-model="mandate.full_name.middle_name"
								type="text"
				...
				<div class="col-md-3">
					<div class="mandate-group">
						<label>Gender:</label>
						<b-input :disabled="mode=='Show'" v-model="mandate.gender" id="gender"></b-input>
					</div>
				</div>
				<!-- Civil Status -->
				<div class="col-md-3">
					<label for="civil-status">Civil Status:</label>
					<b-input :disabled="mode=='Show'" v-model="mandate.civil_status" id="civil-status"></b-input>
				</div>
				<!-- Birthdate -->
				<div class="col-md-3">
					<label for="birthdate">Birthdate:</label>
					<b-input :disabled="mode=='Show'" v-model="mandate.birthdate" id="birthdate" locale="en"></b-input>
				</div>
				<!-- Age -->
				<div class="col-md-3">
