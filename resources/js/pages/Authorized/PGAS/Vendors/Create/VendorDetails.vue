					...
					<div class="form-group">
						...
						<b-input-group>
							...
							<b-input
								...
								required
							></b-input>
							<b-input v-model="form.contact_person.middle_name" type="text" placeholder="Middle Name"></b-input>
						</b-input-group>
					</div>
				</div>
			</div>
				...
				<div class="col-md-6">
					<div class="form-group">
						...
						<b-input-group>
							...
							<b-input v-model="form.registered_address.city" type="text" placeholder="City/Municipality"></b-input>
							<b-input v-model="form.registered_address.zip_code" type="text" placeholder="Zip code"></b-input>
						</b-input-group>
					</div>
				</div>
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<b-input-group>
							<b-input v-model="form.contact_number" type="number" placeholder="09xx-xxxx-xxx" required></b-input>
						</b-input-group>
					</div>
				</div>
			</div>
			...
			<div class="row mb-4">
				...
				<div class="col-md-6">
					...
					<div class="form-group">
						...
						<b-input-group>
							<b-input v-model="form.email_address" type="text" placeholder="email@email.com" required></b-input>
						</b-input-group>
					</div>
				</div>
			</div>
