<template>
	<div>
		...
		<div class="component-sub-content mt-4 mb-4">
			...
			<div class="row mt-2" v-for="(value, value_index) in vendor.bank_details" :key="value_index">
				...
				<div class="col-md-4">
					<b-input-group>
						<b-input
							placeholder="Branch"
							v-model="vendor.bank_details[value_index].bank_address.bank_branch"
							type="text"
						></b-input>
						<b-input
							placeholder="Brgy / City"
							v-model="vendor.bank_details[value_index].bank_address.bank_city"
							type="text"
						></b-input>
					</b-input-group>
				</div>
				<div class="col-md-2">
					<b-input-group>
						<b-input v-model="vendor.bank_details[value_index].account_name" type="text"></b-input>
					</b-input-group>
				</div>
				<div class="col-md-2">
					<b-input-group>
						<b-input v-model="vendor.bank_details[value_index].account_number" type="text"></b-input>
					</b-input-group>
				</div>
				<div class="col-md-1">
					<b-button
						:disabled="value_index==0"
						@click="removeRow(vendor.bank_details, value_index)"
			...
			<div class="mt-4">
				<b-button @click="addRow(vendor.bank_details)" variant="success" block>
