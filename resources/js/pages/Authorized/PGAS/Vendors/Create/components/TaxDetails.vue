<template>
	<div>
		...
		<div class="component-sub-content mt-4 mb-4">
			...
			<div class="row mt-2" v-for="(value, value_index) in vendor.ewt_details" :key="value_index">
				<!-- EWT Details -->
				<div class="col-md-2">
  ...
  computed:{
	...
	watch: {
		...
		selected_description() {
			this.ewt_details.ewt_detail = this.vendor.ewt_details[value_index].ewt_detail.name;
			this.ewt_details.ewt_descripion = this.vendor.ewt_details[value_index].ewt_description.name;
			this.ewt_details.ewt_percent = this.vendor.ewt_details[value_index].ewt_percent.name;
		}
	},
	components: {
		vueStep
