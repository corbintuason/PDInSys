		...
		<div class="component-sub-content mt-4 mb-4">
			<div class="row">
				<div class="col-md-6">
					...
					<!-- Billing Statement -->
					<div
						v-if="vendor.line_business == 'Services' || vendor.line_business == 'Both' || vendor.line_business == '' "
					...
					<div
						v-if="vendor.line_business == 'Goods' || vendor.line_business == 'Both' || vendor.line_business == '' "
				...
				<div class="col-md-6">
					...
					<!-- SEC Certificate -->
					<div
						v-if="vendor.type_business == 'Corporation' || vendor.type_business == '' "
						class="row col-md-12 mt-4"
					>
						<div class="col-md-3 mt-1">
					...
					<div>
						<div
							class="row col-md-12 mt-4"
							v-for="(value, value_index) in vendor.other_attachments"
							:key="value_index"
						>
							<div class="col-md-3 mt-1">
							...
							<div class="col-md-8">
								<!-- <b-form-file v-model="vendor.other_attachments[value_index]"></b-form-file> -->
							</div>
							<div class="col-md-1">
								<b-button
									v-if="value_index==0"
									@click="removeRow(vendor.other_attachments, value_index)"
						...
						<div class="col-md-12 mt-3">
							<b-button @click="addRow(vendor.other_attachments)" variant="success" block>
