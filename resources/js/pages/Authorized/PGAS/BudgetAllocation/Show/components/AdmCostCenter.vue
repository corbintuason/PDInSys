		...
		>
			...
			<div class="row ml-1 mt-1 mb-3">
				...
				<div class="col-md-3">
					<b-form-input
						readonly
						v-model="budget.adm_cost_centers[value_index].adm_cost_code"
						type="text"
					></b-form-input>
				</div>
				<div class="col-md-5">
					<b-form-input
						readonly
						v-model="budget.adm_cost_centers[value_index].adm_cost_description"
						type="text"
					></b-form-input>
				</div>
				<div class="col-md-3">
					<b-input-group prepend="₱" class="font-weight-bold">
						<money readonly :value="total_budget_year(value)" class="total-amount" type="text"></money>
					</b-input-group>
				</div>
			</div>
			<!-- end first row -->
			...
			>
				<div class="col-md-3 ml-md-auto">
					<b-form-input readonly v-model="value.adm_budget_code" type="text"></b-form-input>
				</div>
				<div class="col-md-3">
					<b-form-input readonly v-model="value.adm_budget_description" type="text"></b-form-input>
				</div>
				<div class="col-md-3">
					<b-input-group prepend="₱" append="/ yr" class="font-weight-bold">
						<money readonly class="form-control" v-model="value.adm_budget_year"></money>
					</b-input-group>
				</div>
				<div class="col-md-2">
