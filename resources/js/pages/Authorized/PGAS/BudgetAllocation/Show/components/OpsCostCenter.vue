		...
		>
			...
			<div class="row ml-1 mt-1 mb-3">
				...
				<div class="col-md-3">
					<b-form-input
						readonly
						v-model="budget.ops_cost_centers[value_index].ops_cost_code"
						type="text"
					></b-form-input>
				</div>
				<div class="col-md-5">
					<b-form-input
						readonly
						v-model="budget.ops_cost_centers[value_index].ops_cost_description"
						type="text"
					></b-form-input>
				</div>
				<div class="col-md-3">
			...
			>
				<div class="col-md-3 ml-md-auto">
					<b-form-input readonly v-model="value.ops_budget_code" type="text"></b-form-input>
				</div>
				<div class="col-md-3">
					<b-form-input readonly v-model="value.ops_budget_description" type="text"></b-form-input>
				</div>
				<div class="col-md-2">
					<b-input-group prepend="₱" append="/ yr" class="font-weight-bold">
						<money readonly v-model="value.ops_budget_year" class="form-control"></money>
					</b-input-group>
				</div>
				<div class="col-md-2">
