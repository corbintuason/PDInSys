<template>
	<div>
		...
		<div class="row">
			...
			>
				<b-input-group size="sm">
					<b-form-input disabled :value="selected_vendor ? selected_vendor.trade_name : ''"></b-form-input>
				</b-input-group>
			</b-form-group>
		</div>
		...
		<div class="row">
			...
			<b-form-group class="col-md-3" description="Barangay">
				<b-input-group size="sm">
					<b-form-input disabled :value="selected_vendor ? selected_vendor.registered_address.barangay : ''"></b-form-input>
				</b-input-group>
			</b-form-group>
			...
			<b-form-group class="col-md-3" description="City/Municipality">
				<b-input-group size="sm">
					<b-form-input disabled :value="selected_vendor ? selected_vendor.registered_address.city : ''"></b-form-input>
				</b-input-group>
			</b-form-group>
			...
			<b-form-group class="col-md-3" description="ZIP Code">
				<b-input-group size="sm">
					<b-form-input disabled :value="selected_vendor ? selected_vendor.registered_address.zip_code : ''"></b-form-input>
				</b-input-group>
			</b-form-group>
		</div>
		...
		<div class="row">
			...
			>
				<b-input-group size="sm">
					<b-form-input disabled :value="selected_vendor ? selected_vendor.tin_number : ''"></b-form-input>
				</b-input-group>
			</b-form-group>
		</div>
...
export default{
    ...
    computed:{
        ...
        first_address(){
            ...
            if(this.selected_vendor!=null){
                var registered_address = this.selected_vendor.registered_address;
