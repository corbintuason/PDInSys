<template>
	<div>
		<label>Full Payment Summary</label>
		...
		>
			<b-form inline>
				...
				<b-form-group description="Override %">
					<b-input-group size="sm">
						<b-input v-model="rfp.term_of_payment.full_payment.override"></b-input>
					</b-input-group>
				</b-form-group>
		...
		>
			<b-input-group size="sm">
				...
				<money v-model="rfp.term_of_payment.full_payment.vat_exempt_sales" class="form-control"></money>
			</b-input-group>
		</b-form-group>
		...
		>
			<b-input-group size="sm">
				...
				<money v-model="rfp.term_of_payment.full_payment.vat_zero_rated_sales" class="form-control"></money>
			</b-input-group>
		</b-form-group>
