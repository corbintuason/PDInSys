...
export const vendorModule = {
    ...
    actions: {
        changeMode(context, mode) {
            ...
            if (mode == "Show") {
                context.dispatch("storeVendor", context.state.item.id);
            }
        },
        storeItem(context, id) {
            ...
            return new Promise((resolve, reject) => {
                ...
                axios
                    .get("/api/vendor/" + id)
                    .then((response) => {
                        var vendor = response.data.data;
                        context.commit("storeItem", vendor);
